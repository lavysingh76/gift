                ...
                <div class="row">
                    <div class="col-lg-5 col-md-5">
                        <div class="product-large-slider">
                            <div class="pro-large-img">
                                <img   alt="product-details" id="img" />
                            </div>
                            <!-- <div class="pro-large-img">
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="product-details-des quick-details">
                            ...
                            <div class="price-box">
                            <i class="fa fa-inr"></i><span class="price-regular" id="dis_price"></span>
                             <span class="price-old" ><del id="ori_price"></del></span>
                            </div>
    ...
    <div class="minicart-inner-content">
        ...
        <div class="minicart-content-box">
            <div class="minicart-item-wrapper">
                <ul>
                    ...
                    <li class="minicart-item">
                        ...
                        <div class="minicart-content">
                            <h3 class="product-name">
                                <a href="#">Jasmine flowers white for all flower lovers</a>
                            </h3>
                            <p>
                                <span class="cart-quantity">1 <strong>&times;</strong></span>
            ...
            <div class="minicart-button">
                ...
                <a href="{{url('cart')}}"><i class="fa fa-share"></i> checkout</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    function valueAssin(index)
    {
        var discount;
        // console.log(index);
        // console.log(product[index]);
        document.getElementById('product_name').innerText = product[index].product_name;
        document.getElementById('detail').innerText = product[index].detail;
        document.getElementById('img').src = "../admin/files/product/"+product[index].product_image;
        if(product[index].discount > 0){
           var orignal_price = product[index].price ; 
           var discount = product[index].discount;
           var take_discount = orignal_price*discount/100;
        //    console.log(take_discount);
           var dis_price = orignal_price - take_discount;
           document.getElementById('dis_price').innerText = dis_price;
           document.getElementById('ori_price').innerText =  "₹"+product[index].price;
        //    console.log('if');
        }else{
            // console.log('else');
            document.getElementById('ori_price').innerText =  '';
            document.getElementById('dis_price').innerText =  product[index].price;
        }
  
    }
    function valueAssinNext(index)
    {
        var discount;
        // console.log(index);
        // console.log(product[index]);
