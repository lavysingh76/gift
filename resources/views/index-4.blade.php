...
@section('content')
    ...
    <main>
        ...
        <section class="hero-slider-area">
            <div class="hero-slider-active-2 slick-dot-style">
                <div class="single-slider">
                    <div class="hero-bg" style="background-image:url(img/slider/home2-slider1.jpg)">
                        <div class="container">
                            <div class="row">
                                <div class="col-12">
                ...
                <div class="single-slider">
                    <div class="hero-bg" style="background-image:url(img/slider/home2-slider2.jpg)">
                        <div class="container">
                            <div class="row">
                                <div class="col-12">
                                    <div class="content-inner">
                ...
                <div class="single-slider">
                    <div class="hero-bg" style="background-image:url(img/slider/home2-slider3.jpg)">
                        <div class="container">
                            <div class="row">
                                <div class="col-12">
                                    <div class="content-inner">
                        ...
                        <div class="product-container">
                            ...
                            <div class="product-tab-menu">
                                <ul class="nav justify-content-center">
                                    <li><a href="#tab1" class="active" data-bs-toggle="tab">Daffodil</a></li>
                                    <li><a href="#tab2" data-bs-toggle="tab">Dahlia</a></li>
                                    <li><a href="#tab3" data-bs-toggle="tab">Rose</a></li>
                                    <li><a href="#tab4" data-bs-toggle="tab">Jasmine</a></li>
                                </ul>
                            </div>
                                ...
                                <div class="tab-pane fade" id="tab2">
                                    <div class="product-carousel--4 slick-row-10 slick-arrow-style">
                                        ...
                                        <div class="product-item">
                                            <figure class="product-thumb">
                                                <a href="product-details.html">
                                                    <img class="pri-img" src="{{asset('img/product/product-6.jpg')}}" alt="product">
                                                    <img class="sec-img" src="{{asset('img/product/product-6.jpg')}}" alt="product">
                                                </a>
                                                <div class="product-badge">
                                                    <div class="product-label new">
        ...
        <section class="testimonial-area section-space bg-img" data-bg="{{asset('img/testimonial/testimonials-bg.jpg')}}">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <!-- section title start -->
                        ...
                        <div class="testimonial-thumb-wrapper">
                            <div class="testimonial-thumb-carousel">
                                <div class="testimonial-thumb">
                                    <img src="{{asset('img/testimonial/testimonial-1.png')}}" alt="testimonial-thumb">
                                </div>
                                <div class="testimonial-thumb">
                                    <img src="{{asset('img/testimonial/testimonial-2.png')}}" alt="testimonial-thumb">
                                </div>
                                <div class="testimonial-thumb">
                                    <img src="{{asset('img/testimonial/testimonial-3.png')}}" alt="testimonial-thumb">
                                </div>
                                <div class="testimonial-thumb">
                                    <img src="{{asset('img/testimonial/testimonial-1.png')}}" alt="testimonial-thumb">
                                </div>
                        ...
                        <div class="latest-blog-carousel slick-arrow-style slick-row-15">
                                ...
                                <div class="post-info-wrapper">
                                    <div class="entry-header">
                                        <h2 class="entry-title">
                                            <a href="{{url('blog-details')}}">Flowers daisy pink stick</a>
                                        </h2>
                                        <div class="post-meta">
                                    ...
                                    <a href="{{url('blog-details')}}" class="btn-read">read more...</a>
                                </div>
                            </div>
                            <!-- blog sinle post end -->
                            ...
                            <div class="blog-post-item">
                                ...
                                <div class="post-info-wrapper">
                                    <div class="entry-header">
                                        <h2 class="entry-title">
                                            <a href="{{url('blog-details')}}">Flowers bouquet pink</a>
                                        </h2>
                                        <div class="post-meta">
                                            <div class="post-author">
                                                Written by: <a href="#">Admin</a>
                            ...
                            <div class="blog-post-item">
                                ...
                                <div class="post-info-wrapper">
                                    <div class="entry-header">
                                        <h2 class="entry-title">
                                            <a href="{{url('blog-details')}}">Blossom bouquet flower</a>
                                        </h2>
                                        <div class="post-meta">
                                            <div class="post-author">
                                                Written by: <a href="#">Admin</a>
